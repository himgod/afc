...
/* WID branch */
#define WID_RETURN_CODE_BASE			    		(0x1a0000)
#define WID_RETURN_CODE_SUCCESS      				(COMMON_SUCCESS)		     /*success */   
#define WID_RETURN_CODE_ERR_GENERAL        			(WID_RETURN_CODE_BASE + 1)   /* general failure */
#define WID_RETURN_CODE_BADPARAM      				(WID_RETURN_CODE_BASE + 2)   /* bad parameters */
#define WID_RETURN_CODE_OUT_OF_MEMORY      			(WID_RETURN_CODE_BASE + 3)   /* out of memory */
#define WID_RETURN_CODE_DBUS_ERROR      			(WID_RETURN_CODE_BASE + 4)   /* dbus error */

#define WID_RETURN_CODE_WLAN_EXISTS      			(WID_RETURN_CODE_BASE + 10)   
#define WID_RETURN_CODE_WLAN_NOT_EXISTS      		(WID_RETURN_CODE_BASE + 11)   
#define WID_RETURN_CODE_WLAN_ID_OVER_RANGE      	(WID_RETURN_CODE_BASE + 12)  
#define WID_RETURN_CODE_WLAN_NOT_BIND_ALCGRP    	(WID_RETURN_CODE_BASE + 13)  
#define WID_RETURN_CODE_WLAN_BIND_ALCGRP      		(WID_RETURN_CODE_BASE + 14)  

#define WID_RETURN_CODE_ACL_RULE_ID_OVER_RANGE  	(WID_RETURN_CODE_BASE + 50)  
#define WID_RETURN_CODE_ACL_GROUP_ID_OVER_RANGE 	(WID_RETURN_CODE_BASE + 51)  
#define WID_RETURN_CODE_ACL_RULE_EXISTS       		(WID_RETURN_CODE_BASE + 52)  
#define WID_RETURN_CODE_ACL_RULE_NOT_EXISTS     	(WID_RETURN_CODE_BASE + 53)   
#define WID_RETURN_CODE_ACL_RULE_IN_ACLGRP      	(WID_RETURN_CODE_BASE + 54)   
#define WID_RETURN_CODE_ACL_RULE_NOT_IN_ACLGRP  	(WID_RETURN_CODE_BASE + 55)   
#define WID_RETURN_CODE_ACLGRP_EXISTS       		(WID_RETURN_CODE_BASE + 56)   
#define WID_RETURN_CODE_ACLGRP_NOT_EXISTS       	(WID_RETURN_CODE_BASE + 57)   
#define WID_RETURN_CODE_ACLGRP_IS_BINDED       		(WID_RETURN_CODE_BASE + 58)   
#define WID_RETURN_CODE_ACLGRP_RULE_IS_FULL     	(WID_RETURN_CODE_BASE + 59)   
