...
/*****************************************************************************************
 * DESCRIPTION:
 * 	arg lists for method NPD_DBUS_VLAN_METHOD_CREATE_VLAN_BY_VLAN_LIST_ONE
 *
 * INPUT:
 *	string vlan name - vlanListStr  //vlan list string passed from dcli
 *
 * OUTPUT:
 *	uint32 count  -  count of vlan created successfully
 *	uint32 ret		 - ret		 //npd operation return value,indicates whether it success.
 *
 *****************************************************************************************/
#define NPD_DBUS_VLAN_METHOD_CREATE_VLAN_BY_VLAN_LIST   "create_vlan_by_vlan_list"
/****************************************************************************************
 * DESCRIPTION: * 	
 *      arg lists for method NPD_DBUS_VLAN_METHOD_CREATE_VLAN_BY_VLAN_LIST_ONE
 *
 * INPUT:
 *	uint8 isAdd    -    add or del port 
 *	uint8 slot_no  -   the slot no of the eth port
 *	uint8 local_port_no - the local_port_no of the eth port
 *	string vlan name - vlanListStr  //vlan list string passed from dcli
 *
 * OUTPUT:
 *	uint32 count  -  count of vlan the eth port add/del  successfully
 *	uint32 ret		 - ret		 //npd operation return value,indicates whether it success.
 ****************************************************************************************/
#define NPD_DBUS_VLAN_METHOD_ADD_DEL_ETH_PORT_FOR_VLAN_LIST "add_del_eth_port_for_vlan_list"
...
#define NPD_DBUS_VLAN_METHOD_BOND_VLANLIST_TO_SLOT_CPU  "vlanlist_to_cpu_port_add_del"

#define NPD_DBUS_VLAN_METHOD_CONFIG_VLAN_LIST_PORT_MEMBER_ADD_DEL "vlan_list_port_add_del_for_master_slot"
