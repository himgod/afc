...
*/
char WID_DBUS_ADD_USER_GROUP[PATH_LEN] = "add_softac_wifi_user_group";
char WID_DBUS_DEL_USER_GROUP[PATH_LEN] = "del_softac_wifi_user_group";
char WID_DBUS_MODIFY_USER_GROUP_CONFIG[PATH_LEN] = "modify_softac_user_group_config";

char WID_DBUS_ADD_USER_NETWORK[PATH_LEN] = "add_default_user_network";
char WID_DBUS_ADD_GUEST_NETWORK[PATH_LEN] = "add_default_guest_network";
char WID_DBUS_ADD_NETWORK[PATH_LEN] = "add_softac_wifi_network";
char WID_DBUS_DEL_NETWORK[PATH_LEN] = "del_softac_wifi_network";
char WID_DBUS_MODIFY_NETWORK_CONFIG[PATH_LEN] = "modify_softac_network_config";
char WID_DBUS_LOAD_NETWORK_CONFIG[PATH_LEN] = "load_softac_network_config";
char WID_DBUS_SHOW_NETWORK_CONFIG[PATH_LEN] = "show_network_wlan_config";
char WID_DBUS_SHOW_NETWORK_STA_CONFIG[PATH_LEN] = "show_network_sta_config";
char WID_DBUS_SHOW_NETWORK_WTP_CONFIG[PATH_LEN] = "show_network_wtp_config";
char WID_DBUS_SHOW_NETWORK_WTP_IP_LIST[PATH_LEN] = "show_network_wtp_ip_list";
char WID_DBUS_RESTART_WTP_BY_ID[PATH_LEN] = "restart_wtp_by_id";

char WID_DBUS_CONF_METHOD_SHOWWLAN[PATH_LEN]="show_wlan";
char WID_DBUS_CONF_METHOD_SHOWWLAN_OF_ALL[PATH_LEN]= "show_wlan_of_all";
...
char WID_DBUS_CONF_METHOD_WTPLIST_NEW_BYINTERFACE[PATH_LEN]=	"show_wtp_list_new_byinterface";
char WID_DBUS_CONF_METHOD_SHOWWTP_BYMODEL[PATH_LEN]=  "show_wtp_list_bymodel";
char WID_DBUS_CONF_METHOD_SHOWWTP_BYVERSION[PATH_LEN]= "show_wtp_list_byversion";
...
char  WID_DBUS_WTP_METHOD_SET_WTP_INTERFACE_ETH_MTU[PATH_LEN] =	"set_ap_interface_eth_mtu";
...
char	WID_DBUS_CONF_METHOD_SHOW_CONFIG_WTP[PATH_LEN]= "show_wtp_config_of_all_wtp";
...
/*
 arg lists for method WID_DBUS_CONF_METHOD_ADD_DEL_WTP
  ...
  out arg list:  // in the order as they are appended in the dbus message.
	UNIT32	ret//success or fail(reason)
*/
char WID_DBUS_CONF_METHOD_ADD_WTP[PATH_LEN] = "wid_add_wtp";
char WID_DBUS_CONF_METHOD_DEL_WTP[PATH_LEN] = "wid_del_wtp";
char WID_DBUS_CONF_METHOD_ADD_DEL_WTP_BY_MAC[PATH_LEN] = "add_del_wtp_by_mac";
char WID_DBUS_CONF_METHOD_LOAD_WTP[PATH_LEN] = "wid_load_wtp";
...
char WID_DBUS_WTP_METHOD_LAN_VLAN[PATH_LEN]=   "wtp_lan_vlan";
...
char WID_DBUS_WLAN_METHOD_SET_SILENCE_PERIOD[PATH_LEN] = "wlan_set_sta_silence_period";
char WID_DBUS_WLAN_METHOD_APPAY_WLAN_BALANCE_SWITCH[PATH_LEN]=	"wlan_balance_switch"; /*xm  08/12/29*/
char WID_DBUS_WTP_METHOD_WTP_UNUSED[PATH_LEN]=            "wtp_unused";
...
char WID_DBUS_WTP_METHOD_SET_VERSION_PATH[PATH_LEN]=		"wtp_set_version_path";
char WID_DBUS_WTP_METHOD_CONFIG_PORT_ENABLE[PATH_LEN]=      "wtp_configure_port_enable";
char WID_DBUS_WTP_METHOD_CONFIG_PORT[PATH_LEN]=    		 "wtp_configure_port";
char WID_DBUS_WTP_METHOD_SET_WTPNAME[PATH_LEN]=    		 "wtp_set_wtpname";
char WID_DBUS_WTP_METHOD_SET_WTPSN[PATH_LEN]=    		 "wtp_set_wtpsn";
char WID_DBUS_WTP_METHOD_SET_STANAME[PATH_LEN]=    		 "set_staname";
char WID_DBUS_WTP_METHOD_ARCHIVE_ALERT[PATH_LEN]=        "wtp_archive_alert";
char WID_DBUS_WTP_METHOD_ARCHIVE_ALERTLIST[PATH_LEN]=       "archive_all_alert";
char WID_DBUS_WTP_METHOD_GET_WTP_ALERTIDS[PATH_LEN]=        "get_all_alertids";
char WID_DBUS_CONF_METHOD_GET_COUNTRY_CODE[PATH_LEN]=       "get_country_code";
char WID_DBUS_CONF_METHOD_SET_IP_NETWORK[PATH_LEN]=         "set_ip_network";
char WID_DBUS_CONF_METHOD_COVER_RADIO_WLAN[PATH_LEN]=		"cover_radio_wireless";

char WID_DBUS_WTP_METHOD_RECORD_AP_UPDATE_STATUS[PATH_LEN]= "record_ap_update_status";

char WID_DBUS_WTP_METHOD_SET_WLAN_BALANCE_RSSI[PATH_LEN] = "set_wlan_balance_rssi";
char WID_DBUS_WLAN_METHOD_APPAY_WLAN_BALANCE_TRIGER[PATH_LEN] = "wlan_balance_triger";
char WID_DEBUS_WLAN_METHOD_SET_EAP_MAC[PATH_LEN] =      "wtp_set_eap_mac";
...
char WID_DBUS_METHOD_SET_AP_HEART_STATISTICS_SWITCH[PATH_LEN]= "set_ap_heart_statistics_switch";
char WID_DBUS_METHOD_SET_AP_HEART_STATISTICS_COLLECT_TIME[PATH_LEN]= "set_ap_heart_statistics_collect_time";
...
char WID_DBUS_WLAN_METHOD_SET_PACKET_POWER[PATH_LEN]=	"wlan_set_packet_power";
...
char WID_DBUS_RADIO_METHOD_DYNAMIC_SELECT_CHAN[PATH_LEN]=  "radio_select_channel";
...
/*
 arg lists for method WID_DBUS_CONF_METHOD_ADD_DEL_MAC_GROUP
  in arg list:
	BYTE	isADD //determine ADD(1) or DEL(0)	
	STRING 	GROUPNAME//name of mac group
	BYTE 	GROUPID//ID of mac group which is unique sign of wtp
  out arg list:  // in the order as they are appended in the dbus message.
	UNIT32	ret//success or fail(reason)
*/
char WID_DBUS_CONF_METHOD_ADD_DEL_MAC_GROUP[PATH_LEN]=	"add_del_mac_group";
char WID_DBUS_CONF_METHOD_ADD_DEL_MAC_TOFROM_GROUP[PATH_LEN]=	"add_del_mac_tofrom_group";
char WID_DBUS_CONF_METHOD_MACGROUP[PATH_LEN]=	"macgrp";
char WID_DBUS_CONF_METHOD_SHOWMACGRP[PATH_LEN]=	"show_macgrp";
char WID_DBUS_CONF_METHOD_SHOWMACGRP_ALL[PATH_LEN]=	"show_macgrp_all";

char WID_DBUS_CONF_METHOD_ELECTRONIC_MENU[PATH_LEN]=	"electronic_menu";
char WID_DBUS_CONF_METHOD_MACGRP_SHOW_RUNNING_CONFIG_START[PATH_LEN]=	"macgrp_show_running_config_start";
char WID_DBUS_CONF_METHOD_MACGRP_SHOW_RUNNING_CONFIG_END[PATH_LEN]=	"macgrp_show_running_config_end";
char WID_DBUS_CONF_METHOD_VLANGRP_SHOW_RUNNING_CONFIG_START[PATH_LEN]=	"vlangrp_show_running_config_start";

char WID_DBUS_MACGRP_OBJPATH[PATH_LEN]=	"/aw/wid";
char WID_DBUS_MACGRP_INTERFACE[PATH_LEN]=	"aw.wid";

char WID_DBUS_WTP_METHOD_BIND_MACGRP[PATH_LEN]=	"wtp_bind_macgrp";
char WID_DBUS_WTP_METHOD_UNBIND_MACGRP[PATH_LEN]=	"wtp_unbind_macgrp";
char WID_DBUS_WTP_METHOD_ELECTRONIC_MENU[PATH_LEN]=	"wtp_electronic_menu";

char WID_DBUS_RADIO_METHOD_WLAN_BIND_MACGRP[PATH_LEN]=	"radio_wlan_bind_macgrp";
char WID_DBUS_RADIO_METHOD_WLAN_UNBIND_MACGRP[PATH_LEN]=	"radio_wlan_unbind_macgrp";
char WID_DBUS_RADIO_METHOD_WLAN_ELECTRONIC_MENU[PATH_LEN]=	"radio_wlan_electronic_menu";

char WID_DBUS_WLAN_METHOD_BIND_MACGRP[PATH_LEN]=	"wlan_bind_macgrp";
char WID_DBUS_WLAN_METHOD_UNBIND_MACGRP[PATH_LEN]=	"wlan_unbind_macgrp";
char WID_DBUS_WLAN_METHOD_ELECTRONIC_MENU[PATH_LEN]=	"wlan_electronic_menu";
...
char WID_DBUS_RADIO_WLAN_PACKET_POWER[PATH_LEN]=	"set_radio_wlan_packet_power";
...
char WID_DBUS_RADIO_METHOD_RADIO_APPLY_WLANID_BASE_VLANID_ALIAS_ESSID[PATH_LEN] = "radio_apply_wlanid_base_vlanid_alias_essid";
char WID_DBUS_RADIO_METHOD_RADIO_APPLY_WLANID_CLEAN_ALIAS_ESSID[PATH_LEN]       = "radio_apply_wlanid_clean_alias_essid";
char WID_DBUS_RADIO_METHOD_APPLY_WLAN_ALIAS_ESSID[PATH_LEN]                     = "radio_apply_wlan_alias_essid";

char WID_DBUS_RADIO_METHOD_SET_SA_ENABLE[PATH_LEN]= "set_radio_spectrum_analysis_list_enable";
char WID_DBUS_RADIO_METHOD_SET_SPECTRUM_ANALYSIS_LIST[PATH_LEN]= "set_radio_spectrum_analysis_list";
char WID_DBUS_RADIO_METHOD_SPECTRUM_ANALYSIS[PATH_LEN]=	"radio_spectrum_analysis";
char WID_DBUS_RADIO_METHOD_SHOW_SPECTRUM_ANALYSIS[PATH_LEN]= "radio_spectrum_analysis_show";
char WID_DBUS_RADIO_METHOD_SHOW_SPECTRUM_ANALYSIS_LIST[PATH_LEN]= "show_radiolist_spectrum_analysis";
...
char WID_DBUS_CONF_METHOD_SET_WLAN_STA_TUNNEL_SWITCH_STATE[PATH_LEN] = "set_wlan_tunnel_switch_state";
char WID_DBUS_CONF_METHOD_SET_WLAN_STA_STATE[PATH_LEN] = "set_wlan_sta_state";
...
char WID_DBUS_WTP_METHOD_5G_FIRST_SWITCH[PATH_LEN]              = "wtp_set_ap_5g_first_switch";
char WID_DBUS_WTP_METHOD_5G_FIRST_DISCARD_COUNT[PATH_LEN]       = "wtp_set_ap_5g_first_discard_count";
char WID_DBUS_WTP_METHOD_5G_FIRST_SCANTIME_THR[PATH_LEN]        = "wtp_set_ap_5g_first_scantime_threshold";
char WID_DBUS_WTP_METHOD_5G_FIRST_AGINGTIME_THR[PATH_LEN]       = "wtp_set_ap_5g_first_agingtime_threshold";
char WID_DBUS_WTP_METHOD_5G_FIRST_STACOUNT_THR[PATH_LEN]        = "wtp_set_ap_5g_first_stacount_threshold";
char WID_DBUS_WTP_METHOD_5G_FIRST_SIGNAL_STRENGTH_THR[PATH_LEN] = "wtp_set_ap_5g_first_signal_strength_threshold";

/*ENR-17-BEGIN*/
char WID_DBUS_WLAN_METHOD_CTR_LIST_ENABLE[PATH_LEN]=	"wlan_ctr_list_enable";
char WID_DBUS_WLAN_METHOD_CTR_LIST_TIME[PATH_LEN]=	"wlan_ctr_list_time";
/*ENR-17-END*/

/*station acl group */
char WID_DBUS_CONF_METHOD_ACLGRP_CREATE_ACL_RULE_TCPUDP[PATH_LEN] = "aclgrp_create_acl_rule_tcpudp";
char WID_DBUS_CONF_METHOD_ACLGRP_CREATE_ACL_RULE_ICMP[PATH_LEN] = "aclgrp_create_acl_rule_icmp";
char WID_DBUS_CONF_METHOD_ACLGRP_CREATE_ACL_RULE_DOMAIN[PATH_LEN] = "aclgrp_create_acl_rule_domain";
char WID_DBUS_CONF_METHOD_ACLGRP_DEL_ACL_RULE[PATH_LEN] = "aclgrp_del_acl_rule";
char WID_DBUS_CONF_METHOD_ACLGRP_SHOW_ACL_RULE_ID[PATH_LEN] = "aclgrp_show_acl_rule_id";
char WID_DBUS_CONF_METHOD_ACLGRP_SHOW_ACL_RULE_ALL[PATH_LEN] = "aclgrp_show_acl_rule_all";

char WID_DBUS_CONF_METHOD_ACLGRP_ADD_DEL_ACL_GROUP[PATH_LEN] = "aclgrp_add_del_acl_group";
char WID_DBUS_CONF_METHOD_ACLGRP_CONFIG_ACL_GROUP[PATH_LEN] = "aclgrp_config_acl_group";
char WID_DBUS_CONF_METHOD_ACLGRP_SHOW_ACL_GROUP[PATH_LEN] = "aclgrp_show_acl_group";
char WID_DBUS_CONF_METHOD_ACLGRP_SHOW_ACL_GROUP_ALL[PATH_LEN] = "aclgrp_show_acl_group_all";

char WID_DBUS_ACLGRP_METHOD_ACLGRP_ADD_DEL_ACL_RULE_INGROUP[PATH_LEN] = "aclgrp_add_del_acl_rule_ingroup";
char WID_DBUS_CONF_METHOD_ACLGRP_SHOW_RUNNING_CONFIG_START[PATH_LEN]=	"aclgrp_show_running_config_start";

char WID_DBUS_WLAN_METHOD_BIND_UNBIND_ACLGRP[PATH_LEN] = "wlan_bind_unbind_aclgrp";
char WID_DBUS_ACLGRP_OBJPATH[PATH_LEN]=	"/aw/wid";
char WID_DBUS_ACLGRP_INTERFACE[PATH_LEN]=	"aw.wid";

/* add for dynamic vlan*/
char WID_DBUS_WLAN_METHOD_SET_DYNAMIC_VLAN_ON_OFF[PATH_LEN] = "set_dynamic_vlan_on_off";
char WID_DBUS_WLAN_METHOD_CHANGE_DYNAMIC_VLAN_LIST[PATH_LEN] = "change_dynamic_vlan_list";
/* add for ENR4-3 */
char WID_DBUS_VLAN_GROUP_METHOD_CREATE_VLAN_GROUP[PATH_LEN] = "create_vlan_group";
char WID_DBUS_VLAN_GROUP_METHOD_DELETE_VLAN_GROUP[PATH_LEN] = "delete_vlan_group";
char WID_DBUS_VLAN_GROUP_METHOD_CONFIG[PATH_LEN] = "vlan_group";
char WID_DBUS_VLAN_GROUP_METHOD_SET_WLAN_FOR_VLAN_GROUP[PATH_LEN] = "set_wlan_for_vlan_group";
char WID_DBUS_VLAN_GROUP_METHOD_ADD_DEL_VLAN_GROUP_MEMBER[PATH_LEN] = "add_del_vlan_group_member";
char WID_DBUS_VLAN_GROUP_METHOD_SET_VLAN_FOR_VLAN_GROUP[PATH_LEN] = "set_vlan_for_vlan_group";
char WID_DBUS_METHOD_SET_VLAN_GROUP_SERVICE_ENABLE_DISABLE[PATH_LEN] = "set_vlan_group_service_enable_disable";
char WID_DBUS_CONF_METHOD_SHOW_VLAN_GROUP[PATH_LEN] = "show_vlan_group";

/************for Qos mapping*********************/

char WID_DBUS_WLAN_METHOD_QOS_AC_11E_TO_1P[PATH_LEN]=	"qos_ac_11e_to_1p";
char WID_DBUS_WLAN_METHOD_QOS_AC_11E_TO_1P_DEFAULT[PATH_LEN]=	"qos_ac_11e_to_1p_default";
char WID_DBUS_WLAN_METHOD_QOS_AC_DSCP_TO_1P[PATH_LEN]=	"qos_ac_dscp_to_1p";
char WID_DBUS_WLAN_METHOD_QOS_AC_DSCP_TO_1P_DEFAULT[PATH_LEN]=	"qos_ac_dscp_to_1p_default";
char WID_DBUS_WLAN_METHOD_QOS_AC_DSCP_TO_DSCP[PATH_LEN]=	"qos_ac_dscp_to_dscp";
char WID_DBUS_WLAN_METHOD_QOS_AC_DSCP_TO_DSCP_DEFAULT[PATH_LEN]=	"qos_ac_dscp_to_dscp_default";

char WID_DBUS_WLAN_METHOD_QOS_AP_11E_TO_1P[PATH_LEN]=	"qos_ap_11e_to_1p";
char WID_DBUS_WLAN_METHOD_QOS_AP_11E_TO_1P_DEFAULT[PATH_LEN]=	"qos_ap_11e_to_1p_default";
char WID_DBUS_WLAN_METHOD_QOS_AP_11E_TO_DSCP[PATH_LEN]=	"qos_ap_11e_to_dscp";
char WID_DBUS_WLAN_METHOD_QOS_AP_11E_TO_DSCP_DEFAULT[PATH_LEN]=	"qos_ap_11e_to_dscp_default";
char WID_DBUS_WLAN_METHOD_QOS_AP_DSCP_TO_11E[PATH_LEN]=	"qos_ap_dscp_to_11e";
char WID_DBUS_WLAN_METHOD_QOS_AP_DSCP_TO_11E_DEFAULT[PATH_LEN]=	"qos_ap_dscp_to_11e_default";
char WID_DBUS_WLAN_METHOD_QOS_AP_1P_TO_11E[PATH_LEN]=	"qos_ap_1p_to_11e";
char WID_DBUS_WLAN_METHOD_QOS_AP_1P_TO_11E_DEFAULT[PATH_LEN]=	"qos_ap_1p_to_11e_default";
char WID_DBUS_WLAN_METHOD_SHOW_QOS_MAP_INFO[PATH_LEN]=	"show_qos_map_info";

char WID_DBUS_WLAN_METHOD_SET_AP_11E_TO_1P_MAP_SWITCH[PATH_LEN]=	"qos_ap_11e_to_1p_switch";
char WID_DBUS_WLAN_METHOD_SET_AP_11E_TO_DSCP_MAP_SWITCH[PATH_LEN]=	"qos_ap_11e_to_dscp_switch";

char WID_DBUS_WTP_METHOD_SET_WTP_COMMENT[PATH_LEN] = "set_wtp_comment";
