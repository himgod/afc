...
#define ASD_DBUS_STA_METHOD_SET_ROAMING_RESERVE_SOURCE "set_roaming_reserve_source"
...
#define ASD_DBUS_SECURITY_METHOD_AUTH_POLICY		"auth_policy"
#define ASD_DBUS_SECURITY_METHOD_MAC_AUTH_DOMAIN	"mac_auth_domain"
#define ASD_DBUS_SECURITY_METHOD_WEBAUTH_PASS		"web_auth_pass"
#define ASD_DBUS_SECURITY_METHOD_MACAUTH_EXPIRE		"mac_auth_expire"
...
enum asd_dbus_result {
	...
	ASD_SECURITY_INVALID_AUTH_POLICY,		/* invalid auth policy */
	ASD_MAC_AUTH_DOMIAN_TOO_LONG,
	ASD_SECURITY_SHARED_SECRET_TOO_LONG,
