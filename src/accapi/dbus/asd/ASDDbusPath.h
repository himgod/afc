...
char ASD_DBUS_STA_METHOD_SET_ROAMING_RESERVE_SOURCE[PATH_LEN] =  "set_roaming_reserve_source";
...
char ASD_DBUS_SECURITY_METHOD_AUTH_POLICY[PATH_LEN] = "auth_policy";
char ASD_DBUS_SECURITY_METHOD_MAC_AUTH_DOMAIN[PATH_LEN] = "mac_auth_domain";
char ASD_DBUS_SECURITY_METHOD_WEBAUTH_PASS[PATH_LEN] = "web_auth_pass";
char ASD_DBUS_SECURITY_METHOD_MACAUTH_EXPIRE[PATH_LEN] = "mac_auth_expire";
