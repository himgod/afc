...
int wid_set_wlan_ebr_br_ucast_solicit(unsigned char Wlan_Ebr_ID, unsigned char state, unsigned char Wlan_Ebr_flag);
int wid_set_wlan_ebr_br_mcast_solicit(unsigned char Wlan_Ebr_ID, unsigned char state, unsigned char Wlan_Ebr_flag);
...
int WID_ADD_WLAN_APPLY_RADIO_BASE_NAS_PORT_ID_ALIAS_ESSID
(
	unsigned int RadioID,
	unsigned char WlanID,
	char *nas_port_id,
	unsigned char *ali_essid
);
...
int wid_check_radio_is_apply_wlan(unsigned int RadioID, unsigned char WlanID);
...
unsigned int wid_wlan_change_dynamic_vlan_list(unsigned int add, unsigned int wlanid, unsigned char *dvlanlist, unsigned int dvlanlen);
...
int set_ap_bss_black_white_list(unsigned int wtpid, unsigned int macgrpid);
int set_ap_bss_local_survival_switch(unsigned int wtpid, unsigned char policy);
...
(	
	...
	unsigned char wlanid,
	unsigned char *haddr,
	unsigned int traffic_limit, /* uplink stream from STA */
	unsigned int traffic_limit_send /* downlink stream to STA */
);
