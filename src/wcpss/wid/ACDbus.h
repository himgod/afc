...
int wtp_add_new_alert(unsigned char *mac, int alertid, int archived);
int access_add_new_alert(unsigned char *mac, int alertid, int archived);
int get_access_wtp_alert(unsigned char *mac);
int create_user_wlan(char *ssid, char *user_key);

int  create_guest_wlan(char *ssid);

int add_open_wireless_network
(
	int * wlanid,
	char *ssid, 
	int sHideflag,
...
int del_wpae_wireless_network(unsigned int WlanId);

void bss_bind_wep_security(unsigned int RadioId, unsigned int WlanId, char *user_key);

void bss_bind_wpa_security(unsigned int RadioId, unsigned int WlanId, char *user_key);
