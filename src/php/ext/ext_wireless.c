	...
	for (wlanid = 1; wlanid <= MAX_WLANID; wlanid++)
	{
		...
		else if (wlaninfo.isExist)
		{
			...
			for (i = 0; i < wlaninfo.wlan_wtp_wifi.num; i++)
			{
				...
				add_assoc_long(iter_array_r, "others_sta", (long)wlaninfo.wlan_wtp_wifi.wtp_wifi[i].sta_type_num[Others]);
				add_assoc_long(iter_array_r, "iphone_sta", (long)wlaninfo.wlan_wtp_wifi.wtp_wifi[i].sta_type_num[iPhone]);
				add_assoc_long(iter_array_r, "phone_sta", (long)wlaninfo.wlan_wtp_wifi.wtp_wifi[i].sta_type_num[Phone]);
				add_assoc_long(iter_array_r, "ipad_sta", (long)wlaninfo.wlan_wtp_wifi.wtp_wifi[i].sta_type_num[iPad]);
				add_assoc_long(iter_array_r, "pad_sta", (long)wlaninfo.wlan_wtp_wifi.wtp_wifi[i].sta_type_num[Pad]);
				add_assoc_long(iter_array_r, "macbook_sta", (long)wlaninfo.wlan_wtp_wifi.wtp_wifi[i].sta_type_num[MacBook]);
				add_assoc_long(iter_array_r, "pc_sta", (long)wlaninfo.wlan_wtp_wifi.wtp_wifi[i].sta_type_num[PC]);
				add_assoc_long(iter_array_r, "mi_sta", (long)wlaninfo.wlan_wtp_wifi.wtp_wifi[i].sta_type_num[MI]);
				add_assoc_long(iter_array_r, "wtp_sta", (long)wlaninfo.wlan_wtp_wifi.wtp_wifi[i].sta_num);
				add_assoc_long(iter_array_r, "auth_per", (long)wlaninfo.wlan_wtp_wifi.wtp_wifi[i].sta_auth_per);
				add_assoc_long(iter_array_r, "abn_deauth_per", (long)wlaninfo.wlan_wtp_wifi.wtp_wifi[i].sta_abn_deauth_per);
