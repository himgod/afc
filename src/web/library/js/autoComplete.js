...
mailArr: ["open-wlan-org.com","qq.com", "126.com", "163.com", "hotmail.com", "yahoo.com", "yahoo.com.cn", "live.com", "sohu.com", "sina.com", "chinavalue.net", "chinaksp.net"], //邮件数组
...
var z = settings.zIndex, newArr = mailArr = settings.mailArr, hint = settings.textHint, text = settings.hintText, fc = settings.focusColor;
//创建邮件内部列表内容
...
if (newArr.length == 0) { x.css("left", "-6000px"); }
}).blur(function () {
if (hint && text) {
...
//鼠标经过
var liveValue;
$(".mailHover").bind("mouseover", function () {
