...
!function (a, b) {
    ...
    m.event = {global: {}, add: function (a, b, c, d, e) {
                ...
                while ((e = f.handlers[g++]) && !a.isImmediatePropagationStopped())
					{
						(!a.namespace_re || a.namespace_re.test(e.namespace)) 
							...
							c = (((m.event.special[e.origType] || {}).handle || e.handler).apply) && ((m.event.special[e.origType] || {}).handle || e.handler).apply(f.elem, i), 
							void 0 !== c && 
							(a.result = c) === !1 && 
		...
		if(!(e === 1) && (d == 1 || b==1 || c == 1||bb==1))
			{
			alert("e "+e+" d "+d+ b+c+bb);
			}
    ...
    m.fn.extend({addClass: function (a) {
        ...
        m.fn[b] = function (k, c) {
            return arguments.length > 0 ? this.on(b, null, k, c) : this.trigger(b)
        }
